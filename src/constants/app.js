...
export const BANNER_TYPE = [
  { title: 'Danh sách trung tâm', value: 10 },
  { title: 'Banner trang quảng cáo', value: 11 },
  { title: 'Banner trang chủ dưới', value: 12 },
  { title: 'Banner chào ở trang chủ', value: 13 },
  { title: 'Banner chi tiết lịch hẹn', value: 14 },
  { title: 'Banner đặt lịch thành công', value: 15 },
  // Từ 1001 - 1999 => Dùng cho các "Điểm dịch vụ"
  { title: 'Cứu hộ đăng kiểm', value: 1001 },
  { title: 'Hợp tác xã vận tải', value: 1002 },
  { title: 'Mua bán xe cũ', value: 1003 },
  { title: 'Công ty bảo hiểm', value: 1004 },
  { title: 'Đơn vị cải tạo xe', value: 1005 }
];
