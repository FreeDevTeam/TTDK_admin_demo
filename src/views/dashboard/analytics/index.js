  ...
  return (
    <div id='dashboard-analytics'>
      <Row className='match-height'>
        <Col lg='3' sm='6'>
        <TotalActiveStation data={readAllStationsDataFromLocal} kFormatter={kFormatter} />
        </Col>
        <Col lg='3' sm='6'>
          <TotalInActiveStation data={readAllStationsDataFromLocal} kFormatter={kFormatter} />
        </Col>
        <Col lg='3' sm='6'>
