      ...
      <CardBody>
        ...
        <Row className='pt-50'>
          <div className='col-12'>
            {/*  */}
            <div className='mb-3'>
              <p className='mb-50 my_text'>{props.intl.formatMessage({id: "money"})} SMS {props.intl.formatMessage({id: "temporary"})}: {kFormatter(data.smsSpentAmount ? data.smsSpentAmount : 0)}</p>
