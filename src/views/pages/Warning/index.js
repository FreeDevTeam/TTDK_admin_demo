...
import { handleChangeOpenImportWaring, handleAddDataImportWarning } from "../../../redux/actions/warning";
...
const Warning = ({ intl }) => {
    const statusOptions = [
        { value: intl.formatMessage({ id: "not_yet_punished" }), label: intl.formatMessage({ id: "not_yet_punished" }) },
        { value: intl.formatMessage({ id: "sanctioned" }), label: intl.formatMessage({ id: "sanctioned" }) },
        { value: intl.formatMessage({ id: "no_warning" }), label: intl.formatMessage({ id: "no_warning" }) },
      ]
    ...
    const serverSideColumns = [
        {
            ...
            maxWidth : '100px',
            cell: (row) =>{
                const { customerCriminalRecordId,
                    crimeRecordContact,
                ...
                return (
                    <div className="click_row" onClick={(e) => {
                        e.preventDefault();
                        setModal(true)
                        setUserData({
                            crimeRecordContact,
        ...
        },
        {
            ...
            cell: (row) =>{
                ...
                return (
                    <div className="text-flow">{customerRecordPlatenumber}</div>
                )
            }
        },
        {
            ...
            cell : (row) =>{
                ...
                return (
                    <div dangerouslySetInnerHTML={{__html: customerRecordId}} className="text"/>
                )
            }
        },
        {
            ...
            cell : (row) =>{
                ...
                return (
                    <div dangerouslySetInnerHTML={{__html: crimeRecordStatus}} className="text"/>
                )
            }
        },
        {
        ...
        },
        {
            ...
            cell: (row) => {
                const { 
                    ...
                    crimeRecordLocation,
                    crimeRecordContent,
                    customerCriminalRecordId } = row;
                return (
                    <>
                        <div href='/' className='pointer' onClick={e => {
                            e.preventDefault();
                            setModal(true)
                            setUserData({
                                crimeRecordContact,
                        ...
                        <div
                            className="pointer"
                            onClick={() => ModalSwal(customerCriminalRecordId)}
                        >
        ...
        <Fragment>
            ...
            <ModalBody>
              <Form onSubmit={handleSubmit((data) => {
                ...
                > 
                 <FormGroup>
                    <Label for='crimeRecordContent'>
                      {intl.formatMessage({id: "smsContent"})}
                    </Label>
                    <Input
                  ...
                  <FormGroup>
                    <Label for='customerRecordPlatenumber'>
                      {intl.formatMessage({id: "messagesDetail-customerMessagePlateNumber"})}
                    </Label>
                    <Input
                  ...
                  <FormGroup>
                      <Label for="crimeRecordStatus">
                        {intl.formatMessage({ id: 'status' })}
                      </Label>
                      <Input
                        type="select"
                        id="crimeRecordStatus"
                        name="crimeRecordStatus"
                        value={userData.crimeRecordStatus || ''}
                        onChange={(e) => {
                          const { name, value } = e.target
                          handleOnchange(name, value)
                        }}>
                    ...
                    <FormGroup>
                    <Label for='crimeRecordPIC'>
                      {intl.formatMessage({id: "place_of_warning"})}
                    </Label>
                    <Input
                      id='crimeRecordPIC'
                      name='crimeRecordPIC'
                  ...
                  <FormGroup>
                    <Label for='crimeRecordLocation'>
                      {intl.formatMessage({id: "location_warning"})}
                    </Label>
                    <Input
                  ...
                  <FormGroup>
                    <Label for='crimeRecordContact'>
                      {intl.formatMessage({id: "contact_warning"})}
                    </Label>
                    <Input
...
const FIELD_IMPORT_API = ['customerRecordPlatenumber', 'crimeRecordContent', 'crimeRecordStatus', 'crimeRecordTime', 'crimeRecordPIC', 'crimeRecordLocation', 'crimeRecordContact']
