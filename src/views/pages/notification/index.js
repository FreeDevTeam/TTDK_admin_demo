    ...
    const serverSideColumns = [
        ...
        },
        {
            ...
            cell: (row) =>{
                ...
                return (
                    <div className="text-flow" dangerouslySetInnerHTML={{__html: notificationContent}}/>
                )
            }
        },
        // {
        ...
        // },
        {
            ...
            cell: (row) => {
                ...
                return (
                    <>
                    {notificationImage === null ? <div>-</div> : <a href={notificationImage ? notificationImage : "-"} target='_blank' className="text-flow">
                    <img
                        loading="lazy"
            ...
            cell: (row) => {
                ...
                return (
                    <>
                        ...
                        <div
                            className="pointer"
                            onClick={() => ModalSwal(systemNotificationId)}
                        >
