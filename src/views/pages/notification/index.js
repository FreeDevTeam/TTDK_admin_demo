    ...
    const serverSideColumns = [
        ...
        },
        {
            ...
            cell: (row) =>{
                ...
                return (
                    <div className='text' dangerouslySetInnerHTML={{__html: notificationContent }} />
                )
            }
        },
        // {
        ...
        // },
        {
            ...
            cell: (row) => {
                ...
                return (
                    <>
                    {notificationImage === null ? <div>-</div> : <a href={notificationImage ? notificationImage : "-"} target='_blank'>
                    <img
                        loading="lazy"
