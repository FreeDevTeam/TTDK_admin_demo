        ...
        <Card style={{ paddingLeft: '15px', paddingRight: '15px' }}>
            ...
            <div className="tables">
              <table border="1" width="1500px;" height="500px" align="center">
                ...
                <tr>
                  ...
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumFullFeeCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumFullFeeAmount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumHalfFeeCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumHalfFeeAmount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumNoFeeCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumFirstInspectionPass)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumFirstInspectionFail)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumSecondInspectionPass)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumSecondInspectionFail)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumTemporaryKDVTCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumTemporaryKhKDVTCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumOldCarFirstInspection)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumOldCarSecondInspection)}</th>
                </tr>
              </table>
            </div>
          </Row>
          ...
          <Row className="tables-text mb-3">
            <Col sm="12" md="6" lg="4" xs="12" className="mobie_style">
              ...
              <div>
                {intl.formatMessage({ id: 'Overall_failure_rate' })} {number_to_price(items?.data?.sum?.sumVehicleFailRate)} %
              </div>
            </Col>
            <Col sm="12" md="6" lg="4" xs="12" className="mobie_style">
              <div>
              ...
              <div>
                {intl.formatMessage({ id: 'Failure_rate_of_used_cars' })} {number_to_price(items?.data?.sum?.sumOldVehicleFailRate)}%
              </div>
            </Col>
          </Row>
          <Row>
            <div className="tables">
              <table border="1" width="1500px" height="100px" align="center" style={{ tableLayout: 'fixed' }}>
                ...
                <tr>
                  <th className="thStyle">{intl.formatMessage({ id: 'number_not_agree' })}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumIdentificationFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumFrameSeatBodyFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumEngineFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumPowerTransmissionSystemFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumBrakeSystemFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumDriveSystemFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumSuspensionSystemFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumTiresFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumPowerSystemFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumExhaustFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumNoiseFailCount)}</th>
                  <th className="thStyle">{number_to_price(items?.data?.sum?.sumOtherSystemsFailCount)}</th>
                </tr>
                <tr>
                  <th className="thStyle">Tỷ lệ %</th>
                  <th className="thStyle">{items?.data?.sum?.rateIdentificationFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateFrameSeatBodyFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateEngineFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.ratePowerTransmissionSystemFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateBrakeSystemFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateDriveSystemFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateSuspensionSystemFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateTiresFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.ratePowerSystemFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateExhaustFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateNoiseFailCount?.toFixed(2)}</th>
                  <th className="thStyle">{items?.data?.sum?.rateOtherSystemsFailCount?.toFixed(2)}</th>
                </tr>
              </table>
            </div>
          </Row>
