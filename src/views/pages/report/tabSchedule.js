                            ...
                            <div className='border rounded '>
                                <Row sm='6' className='m-1 h-247'>
                                    <Col sm='4'>
                                        ...
                                        <Progress color="#7367f0" value={(efficiencyConfirmed / total) * 100}  />
                                    </Col>
                                    <Col sm='4'>
                                        <div className='block-icon width-200'>
                                            ...
                                            <div className='color_overload'>{intl.formatMessage({ id: 'canceled' })}</div>
                                        </div>
                                        <div className='color_overload'>{efficiencyCanceled}</div>
                                        <Progress color="danger" value={(efficiencyCanceled / total) * 100} />
                                    </Col>
                                    <Col sm='4'>
                                        <div className='block-icon width-200'>
                                            <div className='bg-deployed'><Icon path={mdiClockCheckOutline} size={1} className='color_deployed ' /></div>
                                            <div className='color_deployed'>{intl.formatMessage({ id: 'closed' })}</div>
                                        </div>
                                        <div className='color_deployed'>{efficiencyClosed}</div>
                                        <Progress color="success" value={(efficiencyClosed / total) * 100} />
                                    </Col>
                                </Row>
                            </div>
                        </CardBody>
