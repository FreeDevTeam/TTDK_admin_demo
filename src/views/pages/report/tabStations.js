...
const TabStations = props => {
    ...
    const totalProductives = ((props?.data?.totalDeployedStation / props?.data?.totalStations) * 100).toFixed(2)
                        ...
                        <CardBody>
                            <Row>
                                <Col sm='2' className='d-flex flex-column flex-wrap text-center'>
                                    <h1 className='font-large-2 font-weight-bolder mt-2 mb-0'>{props?.data?.totalStations}</h1>
                            ...
                            <div className='d-flex justify-content-between mt-1 '>
                                <div className='text-center'>
                                    ...
                                    <span className='font-large-1 font-weight-bold color_actived'>{props?.data?.totalActiveStation}</span>
                                </div>
                                <div className='text-center'>
                                    ...
                                    <span className='font-large-1 font-weight-bold color_deployed '>{props?.data?.totalDeployedStation}</span>
                                </div>
                                <div className='text-center'>
                                    ...
                                    <span className='font-large-1 font-weight-bold color_overload  '>{props?.data?.totalUnavailableStation || 0}</span>
                                </div>
                            </div>
                        </CardBody>
                    </Card>
