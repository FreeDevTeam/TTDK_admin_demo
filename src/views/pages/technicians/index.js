    ...
    },
    {
      ...
      return (
        <div className="style_role">
          ...
          <BasicText appUserLevel={appUserLevel} />
        </div>
      )
      },
    },
        ...
        <Col
          ...
          <Col sm="6" md = '4' lg='2' xs='12' className='mb-1'>
            {/* <Input
              ...
              type="select"
              value={
                dataFilterBody.filter ? dataFilterBody.filter.stationsId || "" : ""
              }
              name="stationsId"
              bsSize="sm"
            >
          ...
          <Col sm="6" md = '4' lg='2' xs='12' className="mb-1">
            {/* <Input
              ...
              type="select"
              //   value={
              //     dataFilterBody.filter ? dataFilterBody.filter.active || "" : ""
              //   }
              name="appUserLevel"
              bsSize="sm"
            >
            ...
            <BasicAutoCompleteDropdown  
              ...
              onChange={({ value }) => handleFilterChange("appUserLevel", value)}
            />
          </Col>
          <Col sm="2" md = '2' lg='2' xs='12' className='d-flex align-items-center mt-0' style={{ margin : '0 0 15px 0', zIndex : '0'}}>
            <CustomInput
              onChange={(e) => {
