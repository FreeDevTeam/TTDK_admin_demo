          ...
          <Card className="mt-4 col-xs-12">
            <CardHeader>
              <CardText className="mt-0 h3">
                ...
                <p className="font-small-4 mt-1">{intl.formatMessage({ id: "total_scheduled" })} : {totalS}</p>
              </CardText>
            </CardHeader>
            <CardBody>
              <ListSchedule appUserId={appUserId} totalSchedule={totalSchedule}/>
            </CardBody> 
            <CardHeader>
              <CardText className="mt-0 h3">
                {intl.formatMessage({ id: "table-vehicle" })}
                <p className="font-small-4 mt-1">{intl.formatMessage({ id: "total_vehical" })} : {totalV}</p>
              </CardText>
            </CardHeader>
            <CardBody>
              <ListVehicle appUserId={appUserId} totalVehicle={totalVehicle}/>
            </CardBody>
          </Card>
        </Col>
      </Row>
