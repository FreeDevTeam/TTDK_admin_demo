...
const classifyOptions = [
  ...
  {value : APP_USER_CATEGORY.NORMAL_USER, label : "personal"},
  {value : APP_USER_CATEGORY.COMPANY, label : "company"}
]

const statusCompany = [
  {value : "", label : "browse_company"},
  {value : COMPANY_STATUS.NOT_ACCEPT, label : "NOT_ACCEPT"},
  {value : COMPANY_STATUS.ACCEPT, label : "ACCEPT"},
  {value : COMPANY_STATUS.NOT_VERIFIED, label : "NOT_VERIFIED"}
]
    ...
    <Fragment>
      <Card>
        <Row className="mx-0 mt-1 mb-50">
          ...
          <Col sm="6" xs='6' md = '4' lg='2' className='mb-1'>
            <Input
              onChange={(e) => {
