...
import { Bell, ChevronDown, Edit, Search, Trash, Framer, Calendar, Eye, X, Circle } from 'react-feather'
      ...
      cell: (row) => {
        ...
        return (
          <div>
            ...
            <div className='text-table'>{clickedRows[scheduleCode] ? fullnameSchedule : `*****${cuoiTen}`}</div>
          </div>
        )
      }
    },
      ...
      cell: (row) => {
        ...
        return (
          <div className='bhtdn'>
            ...
            <div className='d-flex justify-content-end align-items-center'>
            {moment(vehicleExpiryDateBHTNDS,"YYYYMMDD").format(DATE_DISPLAY_FORMAT)} <span
              href="/"
              className="pointer"
              onClick={(e) => {
                setModalOpen(true)
