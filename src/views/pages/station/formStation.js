                    ...
                    <FormGroup row>
                      ...
                      <Col sm="9">
                        <Select
                          ...
                          isClearable={false}
                          defaultValue={{
                            value: CONTRACT_STATUS.find(status => status.value === userData.stationContractStatus)?.value,
                            label: intl.formatMessage({ id: CONTRACT_STATUS.find(status => status.value === userData.stationContractStatus)?.label || "" }),
                          }}
