        ...
        <div className="accountAdmin">
          ...
          <Nav tabs>
            <NavItem>
              ...
              >
                <h3 className="accountAdmin__title-sub mb-2">
                ...
                <Col sm="12">
                  ...
                  {stationReport && (
                    <>
                      <div className="mb-3">
                        <p className="mb-50">
                          {intl.formatMessage({ id: "total" }, { type: "SMS" })}
                      ...
                      <div className="mb-3">
                        <p className="mb-50">
                          {intl.formatMessage({ id: "total" }, { type: "ZNS" })}
