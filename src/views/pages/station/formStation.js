  ...
  function handleUpdateData(data, messageSuccess) {
    const params = {
      ...
      data: {
        ...
        stationManager: data.data.stationManager,
        stationLicense: data.data.stationLicense,
        stationCertification: data.data.stationCertification,
        stationVerifyStatus: data.data.stationVerifyStatus,
      },
    };
    if (previewArr[0]) {
          ...
          <Row>
            <Col sm="12" md="7">
              ...
              >
                  ...
                  <>
                    ...
                    <FormGroup row>
                      ...
                      <Col sm="9">
                        ...
                        />
                        <div>
                          {userData.stationMapSource && !userData.stationMapSource.startsWith("<iframe src=") && (
                            <div className="text-danger mb-1">{intl.formatMessage({ id: "stationMapSourceError" })}</div>
                          )}
                          <h3 className="mt-2 mb-2">{intl.formatMessage({ id: "instruction" })}:</h3>
                          <img src={Instruction} alt={"instruction"} width="100%" />
                          {
                            userData.stationMapSource && userData.stationMapSource.startsWith("<iframe src=") && (
                              <>
                                <h3 className="mt-2 mb-2">{intl.formatMessage({ id: "previewMap" })}:</h3>
                                <div className="map-iframe" dangerouslySetInnerHTML={{ __html: userData.stationMapSource }}></div>
                              </>
                            )
                          }
                ...
                <FormGroup row>
                  <Label sm="3" for="stationManager">
                    {intl.formatMessage({ id: "stationManager" })}
                  </Label>
                ...
                <FormGroup row>
                  <Label sm="3" for="stationLicense">
                    {intl.formatMessage({ id: "stationLicense" })}
                  </Label>
                ...
                <FormGroup row>
                  <Label sm="3" for="stationCertification">
                    {intl.formatMessage({ id: "stationCertification" })}
                  </Label>

                  <Col sm="9">
                    <Input
                      name="stationCertification"
                      id="stationCertification"
                      innerRef={register()}
                      value={userData.stationCertification || ""}
                      placeholder={intl.formatMessage({
                        id: "stationCertification",
                      })}
                      onChange={(e) => {
                ...
                <FormGroup row>
                  ...
                  <Col sm="9">
                  <select name="stationVerifyStatus" id="stationVerifyStatus" onChange={(e) => handleOnchange("stationVerifyStatus", e.target.value)}>
                    <option selected={userData.stationVerifyStatus?.toString() === "0"} value="0">Chưa khai báo</option>
                    <option selected={userData.stationVerifyStatus?.toString() === "1"} value="1">Đã khai báo</option>
                    <option selected={userData.stationVerifyStatus?.toString() === "2"} value="2">Đă đăng kí Bộ Công thương</option>
                  </select>
                  </Col>
                </FormGroup>

                <FormGroup className="d-flex mb-0 justify-content-center">
                  <Button.Ripple disabled={userData.stationMapSource && !userData.stationMapSource.startsWith("<iframe src=")} className="mr-1" color="primary" type="submit">
