...
const FormStation = ({ intl }) => {
  ...
  const stationTypes = [
    { value: meta.STATION_TYPE?.EXTERNAL, label: 'external' },
    { value: meta.STATION_TYPE?.INTERNAL, label: 'internal' },
    { value: meta.STATION_TYPE?.GARAGE, label: 'garage' },
    { value: meta.STATION_TYPE?.HELPSERVICE, label: 'help_service' },
    { value: meta.STATION_TYPE?.INSURANCE, label: 'INSURANCE' },
    { value: meta.STATION_TYPE?.CONSULTING, label: 'consulting_unit' },
    { value: meta.STATION_TYPE?.AFFILIATE, label: 'AFFILIATE' },
    { value: meta.STATION_TYPE?.ADVERTISING, label: 'ADVERTISING' },
    { value: meta.STATION_TYPE?.COOPERATIVE, label: 'COOPERATIVE' },
    { value: meta.STATION_TYPE?.USED_VEHICLES_DEALERSHIP, label: 'USED_VEHICLES_DEALERSHIP' },
    { value: meta.STATION_TYPE?.SPARE_PARTS_DEALERSHIP, label: 'SPARE_PARTS_DEALERSHIP' },
    { value: meta.STATION_TYPE?.PARKING_LOT, label: 'PARKING_LOT' },
    { value: meta.STATION_TYPE?.VEHICLE_MODIFICATION, label: 'VEHICLE_MODIFICATION' },
    { value: meta.STATION_TYPE?.DRIVING_SCHOOL, label: 'DRIVING_SCHOOL' },
    { value: meta.STATION_TYPE?.CHAUFFEUR_SERVICE, label: 'CHAUFFEUR_SERVICE' },
    { value: meta.STATION_TYPE?.PARTS_MANUFACTURING_CONSULTANCY, label: 'PARTS_MANUFACTURING_CONSULTANCY' },
    { value: meta.STATION_TYPE?.DRIVER_HEALTH, label: 'DRIVER_HEALTH' },
  ]
