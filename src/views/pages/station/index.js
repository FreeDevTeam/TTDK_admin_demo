...
import { MoreVertical, Edit, MessageSquare, Mail, Search, Lock, Trash, Briefcase } from 'react-feather'
...
const stationTypes = [
  { value: '', label: 'station_type' },
  { value: 1, label: 'external' },
  { value: 3, label: 'garage' },
  { value: 5, label: 'insurance_unit' },
  { value: 4, label: 'help_service' },
  { value: 6, label: 'consulting_unit' },
]
    ...
    <Fragment>
      <Card>
        <Row className='mx-0 mt-1 mb-50'>
          <Col sm='2' md = '2' lg='2' xs='12' className='d-flex mt-sm-0 mt-1'>
