...
import addKeyLocalStorage, { APP_USER_DATA_KEY, storeAllStationsDataToLocal } from "../../../helper/localStorage";
...
const StationPage = ({ intl }) => {
  ...
  if(dataUser && dataUser?.stationArea?.length !== 3 && dataUser?.stationArea !== null){     // 3 nghĩa là 'ALL'
