...
import { DOCUMENT_CATEGORY } from './../../../constants/app'
import Swal from 'sweetalert2'
import withReactContent from 'sweetalert2-react-content'

const fileOptions = [
  { value: '', label: 'file_type' },
  ...
  const serverSideColumns = [
    {
      ...
      selector: (row) => (
        <div
          onClick={(e) => {
            e.preventDefault()
            history.push('/documentary/form-file', row)
          }}
          className="click_row">
          {row.documentCode}
        </div>
    ...
    <Fragment>
      <Card>
        <Row className="mx-0 mt-1 mb-50">
          <Col sm="2" md="4" lg="3" xs="12" className="mb-1 d-flex">
          ...
          <Col sm="2" xs="12" md="3" lg="2" className="mb-1">
            <Flatpickr
              id="single"
              value={date}
          ...
          }} type='select' name='documentCategory' bsSize='sm' >
            {
          ...
          <Col  sm='2' md="4" xs='12'>
              <Button.Ripple
                ...
                onClick={(e) => {
                  e.preventDefault();
                  history.push("/documentary/add-documentfile", stationsId)
                }}
              >
