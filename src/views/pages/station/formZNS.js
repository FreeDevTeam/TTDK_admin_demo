                ...
                <FormGroup row className="mt-1">
                  ...
                  <Col sm="5">
                    <Input
                      ...
                      invalid={errors.znsUrl}
                      placeholder="ZNS Url"
                      value={(userData && userData.znsUrl) || ""}
                      onChange={(e) => {
                  ...
                  <Col sm="4">
                    <i>Ví dụ: https://example.vn/ZNS</i>
                  </Col>
                </FormGroup>
                <FormGroup row>
