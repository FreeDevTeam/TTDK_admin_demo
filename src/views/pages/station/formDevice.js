              ...
              >
                <Row>
                  <Col sm="6" xs="12">
                    ...
                    <FormSelect control={control} labelId='year_manufacture' name="deviceManufactureYear" rules={{ required: true }} errors={errors} intl={intl} options={getYearOptions()} />
                  </Col>
                  <Col sm="6" xs="12">
