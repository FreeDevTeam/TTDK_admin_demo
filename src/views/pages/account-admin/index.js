...
const DataTableServerSide = ({ intl }) => {
  ...
  function getData(params, isNoLoading) {
    ...
    if (token) {
      ...
      Service.send({
        method: 'POST', path: 'Staff/find', data: newParams, query: null, headers: {
  ...
  function getListRole() {
    ...
    if (token) {
      ...
      Service.send({
        method: 'POST', path: 'Role/find', data: {
          filter: {
  ...
  function handleUpdateData(item, messageSuccess) {
    ...
    if (token) {
      ...
      Service.send({
        method: 'POST', path: 'Staff/updateById', data: item, query: null, headers: {
          Authorization: `Bearer ` + newToken
        }
      }).then(res => {
        if (res) {
