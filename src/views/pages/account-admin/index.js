...
import { ChevronDown, Edit, Lock, MoreVertical, Search, Unlock } from 'react-feather';
...
import addKeyLocalStorage, { APP_USER_DATA_KEY, readAllArea } from '../../../helper/localStorage';
      ...
      <Card className="accountAdmin">
        ...
        <TabContent className='py-50' activeTab={active}>
          ...
          <Button color='primary'
            ...
            <Modal
              isOpen={modal}
              toggle={() => {setModal(false);setValid(false)}}
                    ...
                    !userData.staffId ? (
                      <>
                        <FormGroup>
                          ...
                          />
                          {userNameValid ? <p style={{ color : 'red'}}>{userData.username.length >30 ? intl.formatMessage({id: "max_userName"}) : intl.formatMessage({id: "valid_username"})}</p> : "" }
            ...
            />
                  ...
                  <FormGroup>
                    ...
                    <BasicAutoCompleteDropdown
                      ...
                      value = {
                        listRoles.filter(option => 
                            option.roleId === userData?.roleId)
                      }
                      onChange={(e) => {
