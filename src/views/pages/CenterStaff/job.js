          ...
          <Form
            onSubmit={handleSubmit((data) => {
              ...
              <Input
                ...
                name="appUserRoleId"
                bsSize="md"
                value={data.appUserRoleId || ''}
                onChange={(e) => {
                  const { name, value } = e.target
                  handleOnchange(name, value)
                }}>
                <option value={9999}> {intl.formatMessage({ id: 'chose' })}</option>
                {role.map((item) => {
            ...
            <Col sm='6' xs='12'>
              <FormGroup>
              <Label for="code">{intl.formatMessage({ id: 'ID' })}</Label>
              <Input
                name="appUserId"
            ...
            { data.employeeCode ? <FormGroup>
              <Label for="code">{intl.formatMessage({ id: 'code_dkv' })}</Label>
              <Input
                name="employeeCode"
