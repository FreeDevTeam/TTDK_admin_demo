    ...
    <Fragment>
      <Card>
        ...
        <Col
          ...
          <Col sm="6" md = '4' lg='2' xs='8' className='mb-1'>
            {/* <Input
              onChange={(e) => {
                const { name, value } = e.target;
                handleFilterChange(name, value);
          ...
          <Col sm="2" md = '2' lg='2' xs='6' className='d-flex align-items-center mt-0' style={{ margin : '0 0 15px 0', zIndex : '0'}}>
            <CustomInput
              onChange={(e) => {
