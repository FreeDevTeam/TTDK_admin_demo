...
const FIELD_IMPORT_FULL = ["Mã trạm", "Tên thiết bị", "Tình trạng", "Loại", "Số Seri", "Nhãn hiệu", "Năm sản xuất"]
const FIELD_IMPORT_API = ['stationsId', 'deviceName', 'deviceStatus', 'deviceType', 'deviceSeri', 'deviceBrand', 'deviceManufactureYear']
