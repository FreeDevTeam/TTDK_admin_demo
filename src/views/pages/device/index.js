  ...
  const serverSideColumns = [
      ...
      cell: (_, index, ___) => {
        return (
          <div className='d-flex justify-content-center aligns-items-center'>
            {(currentPage - 1) ? ((currentPage - 1) * DefaultFilter.limit) + index + 1 : index + 1}
          </div>
        )
      },
    },
    ...
    },
    {
      ...
      cell: (row) => {
        ...
        const stationDevicesState = getStationDevicesState(intl);
        const statusColors = {
    ...
    },
    {
      ...
      maxWidth: '200px',
      cell: (row) => {
        return (row.deviceManufactureYear === 0 ? "_" : row.deviceManufactureYear);
      }
    },
    {
    ...
    <Fragment>
      <Card>
        <Row className="mx-0 mt-1 mb-50">
          <Col className="d-flex mt-sm-0 mt-1" md="6" lg="4" sm="12" xs="12" xl="2">
          ...
          <Col className="d-flex mt-sm-0 mt-1 mb-1" md="6" lg="4" sm="12" xs="12" xl="2">
            <Input
              onChange={(e) => {
              ...
              bsSize="sm"
            >
              {getStationDeviceStatusOptions(intl)?.map((item) => (
