...
const ListSchedule = ({ intl }) => {
  ...
  const listTime = [
    {scheduleTime : '7h-9h', scheduleTime : '7h-9h'},
    {scheduleTime : '9h30-11h30', scheduleTime : '9h30-11h30'},
    {scheduleTime : '13h30-15h', scheduleTime : '13h30-15h'},
    {scheduleTime : '15h30-17h30', scheduleTime : '15h30-17h30'},
  ]
  ...
  function getListScheduleTime(param) {
    let filter={
      stationsId: param.stationsId,
      date: param.dateSchedule,
      vehicleType: param.vehicleType
    }
    StationFunctions.getListScheduleTime(filter).then((res) => {
      if (res) {
        setTimeSchedule(res.data)
      } else {
        setTimeSchedule(listTime)
      }
    })
  }
