                ...
                <Row>
                  ...
                  <Col sm="6" sx="12">
                    <FormGroup>
                      ...
                      {/* <p className="mb-0">
                        {changeHistory && changeHistory[0].createdAt} - Đổi từ Trạng thái lịch hẹn {
                          changeHistory && changeHistory[0].dataValueBefore === SCHEDULE_STATUS.NEW ? (
                            <Badge color="light-info" className="size_text">
                              {intl.formatMessage({ id: 'unconfimred' })}
                            </Badge>
                          ) : CustomerScheduleStatus === SCHEDULE_STATUS.CONFIRMED ? (
                          ...
                          changeHistory && changeHistory[0].dataValueAfter === SCHEDULE_STATUS.NEW ? (
                            <Badge color="light-info" className="size_text">
                              {intl.formatMessage({ id: 'unconfimred' })}
                            </Badge>
                          ) : CustomerScheduleStatus === SCHEDULE_STATUS.CONFIRMED ? (
