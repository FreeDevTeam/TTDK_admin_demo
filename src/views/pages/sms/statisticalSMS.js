...
function SmsStatistical({ stationsId }) {
  ...
  const [startDate, setStartDate] = useState(getDateStringFromMoment(moment().subtract(6, 'months')))
      ...
      <div className='d-flex justify-content-end w-100'>
        <Col className="mb-1 d-flex" sm="4" xs="12">
          ...
          <Flatpickr
            ...
            className="form-control form-control-input font ml-1"
            onChange={(date) => {
              handleFilterEndDate(date)
            }}
          />
          <Button color="primary" size="sm" style={{ height: 37, boxSizing: "border-box", marginLeft: 4 }} onClick={() => handleFilterDay()}>
            <Search size={15} />
          </Button>
        </Col>
      </div>
      <div>
        ...
        <Row className='mt-2'>
          <Col lg='3' sm='6' className='mt-lg-0 mt-2'>
            <CustomStatsCard
              data={data.remainingQtyMessageAPNS || 0}
          ...
          <Col lg='3' sm='6' className='mt-lg-0 mt-2'>
            <CustomStatsCard
              data={(data.remainingQtyMessageSmsCSKH + data.remainingQtyMessageSmsPromotion) || 0}
              kFormatter={kFormatter}
          ...
          <Col lg='3' sm='6' className='mt-lg-0 mt-2'>
            <CustomStatsCard
              data={(data.remainingQtyMessageZaloCSKH + data.remainingQtyMessageZaloPromotion) || 0}
              kFormatter={kFormatter}
          ...
          <Col lg='3' sm='6' className='mt-lg-0 mt-2'>
            <CustomStatsCard
              data={data.remainingQtyMessageEmail || 0}
              kFormatter={kFormatter}
              icon={<Mail size={21} />}
              color='info'
