...
import { PAYMENT_TYPES } from '../../../constants/app'
...
const Pay = ({ intl }) => {
  ...
  const serverSideColumns = [
    ...
    // },
    {
      ...
      cell: (row) => {
        ...
        return (
          <>
          {stationPayments == PAYMENT_TYPES.CASH ? intl.formatMessage({ id: 'cash' }) 
          : stationPayments == PAYMENT_TYPES.BANK_TRANSFER ? intl.formatMessage({ id: 'transfer' })
          : stationPayments == PAYMENT_TYPES.VNPAY ? intl.formatMessage({ id: 'VNPAY' })
          : stationPayments == PAYMENT_TYPES.CREDIT_CARD ? intl.formatMessage({ id: 'credit_card' })
          : stationPayments == PAYMENT_TYPES.MOMO ? intl.formatMessage({ id: 'momo' })
          : ''}
          </>
        )
      }
  ...
  //     const response = await SationService.getListStation({
  //       filter: {},
  //       skip: param * 20,
  //       limit: 20,
  //       order: {
        ...
        <Row className="mx-0 mt-1 mb-50">
          ...
          {/* <Col sm="2" xs="6" className="mb-1">
            <Input
              ...
              type="select"
              value={paramsFilter.filter ? paramsFilter.filter.stationStatus || '' : ''}
              name="stationStatus"
              bsSize="sm">
          ...
          {/* <Col sm="2" xs="6" className="mb-1">
            <Input
              ...
              name="stationArea"
              bsSize="sm">
              <option value={''}> {intl.formatMessage({ id: 'Area' })}</option>
          ...
          {/* <Col sm="2" xs="6" className="mb-1">
            <Input
              ...
              type="select"
              value={paramsFilter.filter ? paramsFilter.filter.availableStatus || '' : ''}
