...
function AdvertisingBanner({intl}) {
  ...
  const statusOptions = [
    { value: "", label: "all" },
    { value: 10, label: 'Danh sách trung tâm' },
  ];
  ...
  const columns = [
    ...
    {
      name: intl.formatMessage({ id: 'link_attach' }),
      minWidth: '500px',
      maxWidth: '500px',
      selector: (row) => row.bannerImageUrl,
    },
    {
    ...
    },
    {
      ...
      minWidth: '120px',
      maxWidth: '120px',
      selector: (row) => row.bannerExpirationDate,
    },
    {
        ...
        <Row className="mx-0 mt-1 mb-50">
          <Col sm="2" xs='6' className='mb-1'>
            <Input
              ...
              type="select"
              value={
                paramsFilter.filter ? paramsFilter.filter.bannerSection || "" : ""
              }
              name="bannerSection"
              bsSize="sm"
            >
