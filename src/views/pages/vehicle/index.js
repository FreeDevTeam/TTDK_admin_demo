  ...
  const serverSideColumns = [
    ...
    },
    {
      ...
      cell: (row) => {
        ...
        return (
          <a href={vehicleRegistrationImageUrl ? vehicleRegistrationImageUrl : ""} target="_blank" rel="noopener noreferrer">
            <div>{vehicleRegistrationImageUrl === null ? '' : vehicleRegistrationImageUrl === '' ? '' :
    ...
    },
    {
      ...
      cell: (row) => {
        ...
        const vehicleDay = moment(vehicleExpiryDate , "DD/MM/YYYY").format("YYYY/MM/DD")
        ...
        <ModalBody>
          <Row>
            <Col className='col-6'>
              <Button
                onClick={() => {
                  handleDelete(userData.appUserVehicleId)
                  setModal(false)
                }}
