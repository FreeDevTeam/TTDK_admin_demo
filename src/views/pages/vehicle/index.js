...
const ListVehicle = ({ intl }) => {
      ...
      cell: (row) =>{
        ...
        return (
          <div>{vehicleVerifiedInfo === VEHICLEVERIFIEDINFO.NOT_VERIFIED ? 
           ...
           vehicleVerifiedInfo === VEHICLEVERIFIEDINFO.VERIFIED_BUT_WRONG_EXPIRE_DATE ?
           <p>{intl.formatMessage({ id: "checked_but_wrong_expirationdate" })}</p> :
           vehicleVerifiedInfo === VEHICLEVERIFIEDINFO.VERIFIED_BUT_WRONG_VEHICLE_TYPE ?
           <p>{intl.formatMessage({ id: "checked_but_wrong_vehicle" })}</p> :
           vehicleVerifiedInfo === VEHICLEVERIFIEDINFO.VERIFIED_BUT_ERROR ?
           <p>{intl.formatMessage({ id: "check_but_error" })}</p> :
           <p>{intl.formatMessage({ id: "check_not_serial" })}</p> }
          </div>
        )
      }
    },
  ...
  const accuraceOptions = [
    { value: "", label: "messageStatus" },
    { value: 1, label: "checked" },
    { value: 0, label: "unchecked" },
    { value: -1, label: "checked_but_no_data" },
    { value: -2, label: "checked_but_wrong_expirationdate" },
    { value: -3, label: "check_but_error" },
    { value: -10, label: "checked_but_wrong_vehicle" },
    { value: -20, label: "check_not_serial" },
  ];
      ...
      <Card>
        <Row className="mx-0 mt-1 mb-50">
          ...
          <Col sm='1' className='mb-1 clear_text' id='clear'>
            <Button className='form-control-input ' size="sm" onClick={() => {
              getDataSearch({
                ...paramsFilter,
                filter: {
                },
