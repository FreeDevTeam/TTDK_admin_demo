...
import { ChevronDown, Trash, Edit, Bell, Search } from 'react-feather'
...
const customerReceipt = [
  ...
  {value: 'Pending', label: 'processing-contract'},
...
const ListBill = ({ intl }) => {
  ...
  const serverSideColumns = [
    ...
    {
      name: intl.formatMessage({ id: 'customer_phone' }),
      maxWidth: '250px',
      minWidth: '250px',
      cell: (row) => {
        ...
        <Row className="mx-0 mt-1 mb-50">
          ...
          <Col className="mb-1" sm="2" xs="6">
            <Input
              ...
              type="select"
              value={paramsFilter.filter ? paramsFilter.filter.customerReceiptStatus || '' : ''}
              name="customerReceiptStatus"
              bsSize="sm"
              className="form-control-input">
              {customerReceipt.map((item) => {
          ...
          {/* <Col sm="2" xs="6" className="mb-1">
            <Input
              ...
              type="select"
              value={paramsFilter.filter ? paramsFilter.filter.stationsId || '' : ''}
              name="stationsId"
              bsSize="sm">
              <option value={''}> {intl.formatMessage({ id: 'stationCode' })}</option>
