...
function OverviewChart({ intl, data }) {
  ...
  const options = {
    ...
    series = [
      totalSMSCount && totalSMSCount.total
        ? Math.floor(((totalSMSCount.Completed + totalSMSCount.New) * 100) / totalSMSCount.total)
        : 0,
    ];

  return (
    <div style={{minWidth: "324px"}}>
    <Card className="py-2 ml-2">
      ...
      <Row className='border-top text-center mx-0'>
        <Col xs='4' className='border-right py-1'>
          ...
          <h3 className='font-weight-bolder mb-0'>{totalSMSCount.Completed + totalSMSCount.New || 0}</h3>
        </Col>
        <Col xs='4' className='border-right py-1'>
        ...
        <Col xs='4' className='py-1'>
          ...
          <h3 className='font-weight-bolder mb-0'>{totalSMSCount.Failed + totalSMSCount.Canceled}</h3>
        </Col>
      </Row>
    </Card>
    </div>
